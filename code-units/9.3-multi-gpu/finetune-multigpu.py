...
if __name__ == "__main__":
    ...
    if torch.cuda.is_available():
        ...
        raise Exception("No GPUs found, make sure GPUs are available")

    assert num_gpus >= 4, "At least 4 GPUs are required for this setup. Please select a machine with 4 GPUs."
